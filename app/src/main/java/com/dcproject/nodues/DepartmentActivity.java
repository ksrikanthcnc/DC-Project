...
public class DepartmentActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedScreen(R.id.nav_ViewRequests);
    }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_ViewRequests:
                fragment = new viewRequestsFragment();
                break;
            case R.id.nav_UpdateDue:
                fragment = new updateDueFragment();
                break;
            case R.id.nav_AddDue:
                fragment = new addDueFragment();
                break;
